  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <Field label="Description" className="sm:col-span-2">
        <Textarea name="description" rows={4} defaultValue={championship?.description ?? ""} />
      </Field>
      ...
      <Field label="Logo" className="sm:col-span-2" hint="Shown on tabs, headers and the public site.">
        <MediaPickerInput
          name="logoMediaId"
