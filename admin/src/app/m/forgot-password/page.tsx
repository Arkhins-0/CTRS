...
import { requestMemberPasswordResetAction } from "./actions";
    ...
    return (
      <AuthCard title="Check your inbox">
        <p className="mt-3 text-sm leading-relaxed text-fg-muted">
          If that address belongs to a member account, a reset link is on its way. It expires in
          an hour and can only be used once.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-fg-muted">
          Nothing arrived? Check spam, then try again — or ask your team admin to reset it for you.
        </p>
        <Link
          href="/m/login"
  ...
  return (
    ...
    >
      <p className="mt-2 mb-5 text-sm leading-relaxed text-fg-muted">
        Enter your member email and we&apos;ll send a link to set a new password.
      </p>
      <form action={requestMemberPasswordResetAction} className="space-y-4">
        <Field label="Email">
          <Input
            name="email"
            type="email"
