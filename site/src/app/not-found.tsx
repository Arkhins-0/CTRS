...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-carbon-fibre px-4 py-16 text-center text-white">
      ...
      <h1 className="mt-6 text-[8rem] font-black italic leading-none tracking-tight text-f1-red sm:text-[12rem]">
        404
      </h1>
      ...
      <p className="mt-3 max-w-md text-sm leading-relaxed text-f1-grey-light">
      ...
      <Link
        href="/"
        className="chamfer-tr mt-8 bg-f1-red px-6 py-3 text-sm font-black uppercase tracking-wide text-white transition-colors hover:bg-f1-red-dark"
      >
