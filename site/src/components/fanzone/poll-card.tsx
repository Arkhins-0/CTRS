  ...
  return (
    <form action={votePoll} className="mt-3 space-y-2">
      ...
      {poll.options.map((o) => (
        <label
          key={o.id}
          className="body-s flex cursor-pointer items-center gap-3 rounded-md border border-surface-4 bg-surface-1 px-4 py-2.5 font-semibold text-text-5 transition-colors hover:bg-surface-2 has-checked:border-text-5"
        >
          <input
            type="radio"
            name="optionId"
